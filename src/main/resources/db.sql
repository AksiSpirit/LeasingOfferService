...
ALTER TABLE db.stuff ADD CONSTRAINT fka7n3xtcu5ndh4mdbd620qo37o FOREIGN KEY (position_id) REFERENCES db.position(id);

CREATE TABLE db.offer (
	id varchar(255) NOT NULL,
...
ALTER TABLE db.offer ADD CONSTRAINT fk3lxcsuyqy7179vvjhpdkcqaq8 FOREIGN KEY (office_id) REFERENCES db.office(id);
ALTER TABLE db.offer ADD CONSTRAINT fkau05e5en34p6wka1x606w7bsf FOREIGN KEY (stuff_id) REFERENCES db.stuff(id);
ALTER TABLE db.offer ADD CONSTRAINT fkreo9uevxgoef2sqpy2vk476l1 FOREIGN KEY (client_id) REFERENCES db.client(id);
