	...
	public CommandLineRunner initDb(ClientRepository clientRepository,
		...
		return args -> {
			...
			officeRepository.saveAll(List.of(
					new Office(UUID.randomUUID(), "Head Leasing Office", "Улица Ахахаха, дом 34", "г. Москва, улица Ахахаха, дом 34", 112),
					new Office(UUID.randomUUID(), "Контора", "Улица Страданий, дом 13", "г. Сралово, улица Страданий, дом 13", 7)
			));
