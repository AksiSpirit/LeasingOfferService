	...
	public CommandLineRunner initDb(ClientRepository clientRepository,
		...
		return args -> {
			...
			officeRepository.saveAll(List.of(
					new Office(UUID.fromString("22b30e4e-3406-4881-88e2-3913f51e2782"), "Улица Ахахаха, дом 34", "г. Москва, улица Ахахаха, дом 34", 112),
					new Office(UUID.randomUUID(), "Улица Страданий, дом 13", "г. Сралово, улица Страданий, дом 13", 7)
			));
